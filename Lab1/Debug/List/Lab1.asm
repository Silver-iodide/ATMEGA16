...
; 0000 0091 // RD: PORTB Bit 1
; 0000 0092 // EN: PORTB Bit 2
; 0000 0093 // D4: PORTD Bit 4
; 0000 0094 // D5: PORTD Bit 5
; 0000 0095 // D6: PORTD Bit 6
; 0000 0096 // D7: PORTD Bit 7
...
; 0000 0099 
; 0000 009A /*
; 0000 009B Task 1: Use the I/O ports to control LED1 and LED2
; 0000 009C such that only one LED is on at any given time,
; 0000 009D alternating states every 100ms.
; 0000 009E 
; 0000 009F Status: Done
; 0000 00A0 */
; 0000 00A1 
; 0000 00A2 /*
; 0000 00A3 Task 2: Show 'Hello World' in first row of LCD,
; 0000 00A4 show 0-9 sequentially every 1s.
; 0000 00A5 
; 0000 00A6 Status: Done
; 0000 00A7 */
; 0000 00A8 
; 0000 00A9 // Set both PA3 and PA4 as input
; 0000 00AA DDRA.3 = 1;
	SBI  0x1A,3
; 0000 00AB DDRA.4 = 1;
	SBI  0x1A,4
; 0000 00AC 
; 0000 00AD // Make one LED on
; 0000 00AE PORTA.3 = 1;
	SBI  0x1B,3
; 0000 00AF 
; 0000 00B0 lcd_putchar('Z');
	LDI  R26,LOW(90)
	RCALL _lcd_putchar
; 0000 00B1 lcd_putchar('H');
	LDI  R26,LOW(72)
	RCALL _lcd_putchar
; 0000 00B2 lcd_putchar('E');
	LDI  R26,LOW(69)
	RCALL _lcd_putchar
; 0000 00B3 lcd_putchar('N');
	LDI  R26,LOW(78)
	RCALL _lcd_putchar
; 0000 00B4 lcd_putchar('G');
	LDI  R26,LOW(71)
	RCALL _lcd_putchar
; 0000 00B5 lcd_putchar(' ');
	LDI  R26,LOW(32)
	RCALL _lcd_putchar
; 0000 00B6 lcd_putchar('G');
	LDI  R26,LOW(71)
	RCALL _lcd_putchar
; 0000 00B7 lcd_putchar('r');
	LDI  R26,LOW(114)
	RCALL _lcd_putchar
; 0000 00B8 lcd_putchar('a');
	LDI  R26,LOW(97)
	RCALL _lcd_putchar
; 0000 00B9 lcd_putchar('n');
	LDI  R26,LOW(110)
	RCALL _lcd_putchar
; 0000 00BA lcd_putchar('d');
	LDI  R26,LOW(100)
	RCALL _lcd_putchar
; 0000 00BB lcd_putchar(' ');
	LDI  R26,LOW(32)
	RCALL _lcd_putchar
; 0000 00BC lcd_putchar('S');
	LDI  R26,LOW(83)
	RCALL _lcd_putchar
; 0000 00BD lcd_putchar('l');
	LDI  R26,LOW(108)
	RCALL _lcd_putchar
; 0000 00BE lcd_putchar('a');
	LDI  R26,LOW(97)
	RCALL _lcd_putchar
; 0000 00BF lcd_putchar('m');
	LDI  R26,LOW(109)
	RCALL _lcd_putchar
...
_0x9:
; 0000 00C4 {
; 0000 00C5 // First functionality: Display numbers 0-9 on the LCD every 1s
; 0000 00C6 i--;
	__SUBWRN 16,17,1
; 0000 00C7 
; 0000 00C8 // Second functionality: Switch LEDs states every 100ms
; 0000 00C9 
; 0000 00CA PORTA.3 = PORTA.4;
	SBIC 0x1B,4
	RJMP _0xC
	CBI  0x1B,3
	RJMP _0xD
...
; 0000 00CC delay_ms(100);
	...
	RCALL _delay_ms
; 0000 00CD 
; 0000 00CE // Check whether 1s passed;
; 0000 00CF // If not, continue switch the LEDs states
; 0000 00D0 if (i > 0) {
	CLR  R0
	CP   R0,R16
	CPC  R0,R17

...
; 0000 0080 // INT0: On
; 0000 0081 // INT0 Mode: Falling Edge
; 0000 0082 // INT1: On
; 0000 0083 // INT1 Mode: Falling Edge
; 0000 0084 // INT2: Off
; 0000 0085 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0086 MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(10)
	OUT  0x35,R30
; 0000 0087 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0088 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0089 
...
; 0000 00A1 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00A2 
; 0000 00A3 // Globally enable interrupts
; 0000 00A4 #asm("sei")
	sei
; 0000 00A5 
; 0000 00A6 // Task 1: Use Delay function to implement the LED light's on and off every 0.5s and every 5s.
; 0000 00A7 // Status: Done
; 0000 00A8 /* DDRA.3 = 1;
; 0000 00A9 
; 0000 00AA while (1)
; 0000 00AB       {
; 0000 00AC       // Place your code here
; 0000 00AD       PORTA.3 = ~PORTA.3;
; 0000 00AE       delay_ms(5000);
; 0000 00AF       }
; 0000 00B0 
; 0000 00B1 */
; 0000 00B2 
; 0000 00B3 // Task 2: Using the scanning method:
; 0000 00B4 // When button 1 is pressed, LED1 turns on and LED2 turns off;
; 0000 00B5 // when button 2 is pressed, LED1 turns off and LED2 turns on.
; 0000 00B6 // Status: Done
; 0000 00B7 /*
; 0000 00B8 DDRA.3 = 1;
; 0000 00B9 DDRA.4 = 1;
; 0000 00BA 
; 0000 00BB while (1)
; 0000 00BC     {
; 0000 00BD     if (PIND.2 != 1) {
; 0000 00BE         // Light up PA3, close PA4
; 0000 00BF         PORTA.3 = 1;
; 0000 00C0         PORTA.4 = 0;
; 0000 00C1         }
; 0000 00C2     if (PIND.3 != 1) {
; 0000 00C3         // Light up PA4, close PA3
; 0000 00C4         PORTA.4 = 1;
; 0000 00C5         PORTA.3 = 0;
; 0000 00C6         }
; 0000 00C7 
...
; 0000 00C9 */
; 0000 00CA 
; 0000 00CB // Task 3: Using the interrupt method:
; 0000 00CC // When button 1 is pressed, LED1 turns on and LED2 turns off;
; 0000 00CD // when button 2 is pressed, LED1 turns off and LED2 turns on.
; 0000 00CE // Status: Done
; 0000 00CF // DDRA.3 = 1;
; 0000 00D0 // DDRA.4 = 1;
; 0000 00D1 
; 0000 00D2 // Task 4: make an LED blink with two different intervals—0.5 seconds and 5 seconds
; 0000 00D3 DDRB.3 = 1;
	SBI  0x17,3
; 0000 00D4 while(1) {
_0xD:
